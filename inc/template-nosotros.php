...
<main id="home" class="bg-dark-50">
    ...
    <?php if (!empty($sucesos)):
        $timeline_icon = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        // Dividir sucesos: fila superior (índices pares), inferior (impares)
        $fila_top = [];
        $fila_bottom = [];
                                    ...
                                    ?>
                                        <div class="w-1/3 flex-shrink-0 snap-center pb-[24px]" data-aos="fade-up"
                                            ...
                                            <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                                                ...
                                                <?php endif; ?>
                                                <?php if ($item_desc): ?>
                                                    <p class="text-[14px] leading-relaxed text-gray-600 text-left">
                    ...
                    <?php if ($pres_texto_1 || !empty($pres_lista_1) || $pres_texto_2 || !empty($pres_lista_2)): ?>
                        <div class="grid grid-cols-2 gap-8">
                            ...
                            <?php if ($pres_texto_1 || !empty($pres_lista_1)): ?>
                                <div>
                                    <?php if ($pres_texto_1): ?>
                                        <h3 class="font-medium text-xl mb-4 text-gray-900">
