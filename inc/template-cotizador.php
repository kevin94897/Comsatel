...
/**
 * Template Name: Cotizador Standalone
 */
                        ...
                        <div class="lg:sticky lg:top-24 space-y-8">
                            ...
                            <div class="mb-8">
                                <h2 class="text-2xl md:text-4xl font-normal text-dark mb-4">
                                    Cotiza una solución para tu flota
                                </h2>
                                <p class="text-black leading-relaxed">
                                    Tecnología de monitoreo, control y seguridad adaptada a tu operación. </p>
                            </div>
                                ...
                                <div class="step-item-vertical page-active" data-step="1">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <!-- <p class="text-sm text-gray-500">Información personal o de empresa</p> -->
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="step-item-vertical" data-step="2">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <!-- <p class="text-sm text-gray-500">Configura tu solución a medida</p> -->
                                        </div>
                                    </div>
                                </div>
                            </div>
