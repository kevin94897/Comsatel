...
<section class="py-16 lg:py-24 relative" id="otras-soluciones">
    <div class="container mx-auto px-4 lg:px-8">
        ...
        <!-- SWIPER WRAPPER -->
        <div class="swiper myServiciosSlider">
            <div class="swiper-wrapper">
                ...
                <?php while ($servicios_query->have_posts()):
                    ...
                    $p_imagen = get_the_post_thumbnail_url($p_id, 'large');
                    $p_encabezado = get_field('encabezado', $p_id);
                    ...
                    <div class="swiper-slide">
                        <div class="grid lg:grid-cols-2 gap-8 items-center bg-white rounded-2xl shadow-lg overflow-hidden my-4 p-4"
                            ...
                            <div class="p-8 lg:p-12">
                                ...
                                <?php if ($p_desc): ?>
                                    <p class="my-6"><?php echo esc_html($p_desc); ?></p>
                                <?php endif; ?>

                                <a href="<?php echo esc_url($p_permalink); ?>" class="btn btn-primary">
                                    Más información
                                </a>
                            </div>
        ...
        <div class="flex justify-end gap-4 mb-6 mt-4">
            <button
                class="servicios-prev group py-2.5 px-3 rounded-full border border-dark flex items-center justify-center hover:border-red-600 hover:text-primary transition-all bg-transparent">
            ...
            <button
                class="servicios-next group py-2.5 px-3 rounded-full border border-dark flex items-center justify-center hover:border-red-600 hover:text-primary transition-all bg-transparent">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="24" viewBox="0 0 30 24" fill="none">
                    <path
