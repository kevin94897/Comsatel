            ...
            while ($blog_query->have_posts()):
                ...
                if ($modal_count === 1): ?>
                    <div class="flex flex-col h-full">
                        <div class="relative w-full aspect-video rounded-2xl overflow-hidden mb-8 group">
                        ...
                        <div class="flex-1 flex flex-col items-start">
                            ...
                            <div class="text-black line-clamp-3 text-sm md:text-base">
                                <?php the_excerpt(); ?>
                            </div>
                            <a href="<?php the_permalink(); ?>"
                                class="text-primary font-medium hover:text-primary-dark inline-flex items-center gap-2 mt-auto group">
                                Conocer más
                    ...
                    ?>
                        <article class="flex flex-row gap-4 md:gap-6 group items-center">
                            <div class="w-5/12 aspect-[4/3] rounded-2xl overflow-hidden shrink-0">
                                <a href="<?php the_permalink(); ?>" class="block w-full h-full text-dark">
                                    <?php if (has_post_thumbnail()): ?>
