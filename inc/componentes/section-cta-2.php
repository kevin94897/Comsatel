...
<section id="cta-2" class="relative pt-24 lg:pt-36 pb-4 overflow-hidden bg-gray-50">
    ...
    <!-- Background image -->
    <div class="absolute inset-0 flex items-end justify-center overflow-hidden pointer-events-none">
        <img
            src="<?php echo get_template_directory_uri(); ?>/images/comsatel_home_cta-2.png"
            alt="Plataforma en múltiples dispositivos"
            class="md:w-full h-full object-cover md:max-h-none md:object-cover">
    </div>
    ...
    <div class="relative container mx-auto px-4" data-aos="zoom-in" data-aos-delay="200">
        <div class="grid grid-cols-1 lg:grid-cols-2 items-center gap-8">
            ...
            <div class="p-2 lg:p-10">
                ...
                <p class="text-xs md:text-sm lg:text-base text-white mb-4">
                    Recibe contenido técnico, recomendaciones, casos reales y guías
                    para mejorar la seguridad de tu operación.
                </p>
