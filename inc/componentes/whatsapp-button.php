...
// Si tiene 9 dígitos, asumimos que es de Perú y le falta el 51
if (strlen($clean_number) === 9) {
    ...
    <div id="whatsapp-balloons"
        ...
        <div
            ...
            <button onclick="closeBalloon(event)"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 text-black" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
