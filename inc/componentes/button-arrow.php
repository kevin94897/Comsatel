...
$defaults = array(
    ...
    'rel' => '',
    'show_arrow' => true,
    'extras' => array(), // Atributos HTML adicionales: array('data-id' => '123')
);
...
// Sanitizar valores
$text = $args['text']; // No escapamos aquí para permitir HTML sútil si es necesario, se escapa en el output o se confía en el contexto
...
// Agregar atributos extras
foreach ($extras as $attr => $value) {
    if ($attr === 'class' || $attr === 'href')
