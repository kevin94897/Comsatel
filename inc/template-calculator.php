...
<main class="calculator-page bg-gray-50 md:pt-36 pt-24">
                            ...
                            <div data-aos="fade-right">
                                <form id="calculator-form" class="space-y-8">
                                    ...
                                    <div class="calculator-question">
                                        ...
                                        <input type="number" id="vehicles-count" name="vehicles_count"
                                            class="w-full md:max-w-[300px] max-w-[200px] md:h-[56px] h-[40px] text-center text-xl"
                                            placeholder="40" value="40" min="1" required>
                                    </div>
                                    ...
                                    <div class="calculator-question">
                                        ...
                                        <div class="flex gap-2">
                                            <input type="number" id="km-per-month" name="km_per_month"
                                                class="w-full md:max-w-[300px] max-w-[200px] md:h-[56px] h-[40px] text-center text-xl"
                                                placeholder="1000" value="1000" min="1" required>
                                    ...
                                    <div class="calculator-question">
                                        ...
                                        <div class="flex gap-2">
                                            <input type="number" id="km-per-gallon" name="km_per_gallon"
                                                class="w-full md:max-w-[300px] max-w-[200px] md:h-[56px] h-[40px] text-center text-xl"
                                                placeholder="40" value="40" min="1" step="0.1" required>
                                            <select id="fuel-unit" name="fuel_unit"
                                    ...
                                    <div class="calculator-question">
                                        <label class="flex items-start gap-3 mb-4">
                                            ...
                                            <span class="md:text-2xl text-lg font-medium text-gray-900 pt-0.5">
                                                ¿Cuál es el costo promedio por hora extra?
                                            </span>
                                        </label>
                                        <div class="flex gap-2">
                                            <div class="flex items-center py-2 bg-gray-50">
                                                <span class="text-black font-medium text-lg">S/</span>
                                            </div>
                                            <input type="number" id="overtime-rate" name="overtime_rate"
                                                class="w-full md:max-w-[245px] max-w-[145px] md:h-[56px] h-[40px] text-center text-xl rounded-r-md border-gray-200"
                                                placeholder="30.00" value="30.00" min="0" step="0.1" required>
                                        </div>
                                    </div>
                    ...
                    <div class="" data-aos="fade-left">
                        ...
                        <div class="md:mb-10 mb-6">
                            ...
                            <p class="text-black text-lg md:mb-12 mt-6">
                                Equivalente a un <span class="font-medium text-black" id="savings-percentage">37%</span>
                                menos en costos operativos
                            </p>
                        </div>
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <img src="<?php echo get_template_directory_uri(); ?>/images/icons/comsatel_icon_herramientas.png"
                                            alt="Ahorros en mantenimiento">
                                    </div>
                                    <div>
                                        <h3 class="font-medium text-black text-xl mb-4">
                                            Ahorros en<br>Mantenimiento
                                        </h3>
                                        <p class="md:text-3xl text-2xl font-medium text-primary mb-0"
                        ...
                        <div class="mt-10 flex flex-col sm:flex-row gap-4 max-w-4xl mx-auto">
                            <button type="button" id="email-report-btn" class="btn btn-outline flex-1 !py-3">
                                Enviar reporte por correo
                            </button>
                            <button type="button" id="request-consultation-btn" class="btn btn-secondary flex-1 !py-3">
    ...
    <?php
    // Bridge between ACF and calculator.js
    $calc_config = [
        'saving_efficiency' => get_field('saving_efficiency', 'option') ?: 0.02,
        'saving_driving' => get_field('saving_driving', 'option') ?: 0.08,
        'saving_reduction' => get_field('saving_reduction', 'option') ?: 0.03,
        'maintenance_savings_pct' => get_field('maintenance_savings_pct', 'option') ?: 0.075,
        'tires_savings_pct' => get_field('tires_savings_pct', 'option') ?: 0.075,
        'fuel_price_per_gallon' => get_field('fuel_price_per_gallon', 'option') ?: 20.00,
        'tires_cost_annual' => get_field('tires_cost_annual', 'option') ?: 6000.00,
        'maintenance_cost_annual' => get_field('maintenance_cost_annual', 'option') ?: 9000.00,
    ];
    ?>
    <script>
        window.CALCULATOR_DYNAMIC_CONFIG = <?php echo json_encode($calc_config); ?>;
    </script>
