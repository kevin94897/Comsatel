            ...
            <div class="grid lg:grid-cols-2 gap-x-12 gap-y-16">
                ...
                if ($query->have_posts()):
                    ...
                    while ($query->have_posts()):
                        ...
                        ?>
                        <article class="flex flex-col md:flex-row gap-6 items-center" data-aos="fade-up"
                                ...
                                <?php if ($descargable):
                                    ...
                                    <a href="<?php echo esc_url($file_url); ?>" target="_blank" download
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="w-5 h-5 transition-transform group-hover/link:translate-x-0.5" fill="none"
