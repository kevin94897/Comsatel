...
<main class="producto-gps-page bg-gray-50">
    ...
    $nav_buttons = array(
        ...
        array('label' => 'Resultados medibles', 'url' => '#stats-cards', 'style' => 'btn btn-outline-white', 'delay' => 600),
        array('label' => 'Preguntas frecuentes', 'url' => '#faqs', 'style' => 'btn btn-outline-white', 'delay' => 700),
    );
