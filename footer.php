...
<footer id="colophon" class="site-footer bg-gray-100 pt-8 pb-8">
	<div class="container-full mx-auto px-4 lg:px-8">
		...
		<div class="flex flex-col lg:flex-row justify-between md:items-center mb-12 pb-6 border-b border-gray-300">
			<?php if (!empty(get_field('texto', 'option'))): ?>
				<h3 class="text-lg lg:text-xl font-medium text-dark mb-6 lg:mb-0">
					<?php echo esc_html(get_field('texto', 'option')); ?>
				</h3>
			<?php endif; ?>
			...
			<div class="lg:col-span-1 border-b border-gray-200">
				<h4
					...
					<span class="flex-shrink-0 text-red-500 lg:hidden">
						<svg class="arrow-up-footer w-4 h-4 transform -rotate-45 transition-transform duration-300"
