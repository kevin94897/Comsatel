	...
	<div class="container-full mx-auto px-4 lg:px-8">
		...
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 md:gap-8 lg:gap-12 mb-12">
			...
			<div class="lg:col-span-1 mb-12">
				...
				<div class="flex gap-4">
					<a href="https://instagram.com/comsatel" target="_blank" rel="noopener noreferrer"
						class="text-black hover:text-primary transition-colors" aria-label="Instagram">
					...
					<a href="https://twitter.com/comsatel" target="_blank" rel="noopener noreferrer"
						class="text-black hover:text-primary transition-colors" aria-label="Twitter">
						<svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
							<path
					...
					<a href="https://linkedin.com/company/comsatel" target="_blank" rel="noopener noreferrer"
						class="text-black hover:text-primary transition-colors" aria-label="LinkedIn">
						<svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
							<path
					...
					<a href="https://facebook.com/comsatel" target="_blank" rel="noopener noreferrer"
						class="text-black hover:text-primary transition-colors" aria-label="Facebook">
						<svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
							<path
					...
					<a href="https://youtube.com/comsatel" target="_blank" rel="noopener noreferrer"
						class="text-black hover:text-primary transition-colors" aria-label="YouTube">
						<svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
							<path
			...
			<div class="lg:col-span-1 border-b border-gray-200">
				...
				?>
					<nav class="accordion-content space-y-3 max-h-0 opacity-0 lg:max-h-full lg:opacity-100 overflow-hidden transition-all duration-300">
						<a href="#" class="block text-black hover:text-primary transition-colors">Términos y
							condiciones</a>
			...
			<div class="lg:col-span-1">
				...
				?>
					<nav class="accordion-content space-y-3 max-h-0 opacity-0 lg:max-h-full lg:opacity-100 overflow-hidden transition-all duration-300">
						<a href="#" class="block text-black hover:text-primary transition-colors">Nuestras oficinas</a>
						<a href="#" class="block text-black hover:text-primary transition-colors">Ticket de soporte</a>
						<a href="#" class="block text-black hover:text-primary transition-colors">Portal facturas</a>
					</nav>
				<?php
					},
				));
			...
			<div class="lg:col-span-1">
				...
				<a href="<?php echo esc_url(home_url('/libro-de-reclamaciones/')); ?>" class="btn btn-outline !rounded-md !text-sm !px-4 !py-3 text-left gap-2 text-left">
					...
					<span class="text-left">Libro de reclamaciones</span>
				</a>
			</div>
		</div>
		...
		<div class="pt-8 border-t border-gray-300">
			<div class="flex flex-col md:flex-row justify-between items-center gap-4">
				<p class="text-sm text-black text-center md:text-left mb-0">
					© <?php echo date('Y'); ?> <?php bloginfo('name'); ?>. Todos los derechos reservados.
				</p>
				<div class="md:flex-row flex-col gap-4 text-sm">
					<a href="#" class="text-black hover:text-primary transition-colors">Política de Privacidad</a>
					<span class="text-gray-400">|</span>
					<a href="#" class="text-black hover:text-primary transition-colors">Términos de Servicio</a>
				</div>
			</div>
		</div>
