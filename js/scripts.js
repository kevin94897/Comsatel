(function ($) {
  ...
  $(document).ready(function () {
    ...
    $('.accordion-title').on('click', function () {
      ...
      // Fix: search inside adjacent block if nested
      if (!$content.length) {
        $content = $(this).next().hasClass('accordion-content') ? $(this).next() : $(this).next().find('.accordion-content');
      }
    ...
    const $searchTrigger = $('#search-desktop-trigger, #search-mobile-trigger');
