        ...
        <div class="container-full md:mx-auto md:px-4 lg:px-8 relative z-10">
            <div class="max-w-xl mb-10">
                ...
                <button class="btn btn-primary open-benefit-modal"
                    data-partner="<?php echo esc_attr(get_the_title()); ?>">Acceder al beneficio</button>
            </div>
        </div>
    ...
    <section class="pb-8 md:pb-12">
        <div class="container mx-auto px-4 lg:px-8">
            ...
            <div class="mt-12">
                ...
                <p>Finalizado el servicio de planchado, Fiocco te obsequia lavado externo + aspirado por dentro y lavado
                    del tablero.</p>
            </div>
            <div class="mt-12">
                <p class="font-medium text-lg">Recuerda:</p>
                <ul class="ml-10">
                    <li>Para gozar de este beneficio deben haber pasado como mínimo 7 días hábiles después de iniciar o
                        haber renovado tu servicio.</li>
