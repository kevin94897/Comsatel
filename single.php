			...
			<div class="container mx-auto px-4">
				<nav class="flex items-center gap-2 text-sm text-black whitespace-nowrap overflow-x-auto scroll-smooth"
					...
					<a href="<?php echo home_url('/blog/'); ?>"
						class="hover:text-primary transition-colors text-gray">Blog</a>
					<span>></span>
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(''); ?>>
			<div class="container mx-auto px-4 py-8 md:py-12">
				<div class="max-w-4xl mx-auto">
					...
					<!-- Content -->
					<div class="prose prose-lg max-w-none blog-content" data-aos="fade-up" data-aos-duration="1000"
						data-aos-delay="800" data-aos-anchor-placement="top-bottom">
						<?php the_content(); ?>
					</div>
					...
					if ($tags):
						?>
						<div class="mt-8 pt-8 border-t border-gray-200" data-aos="fade-up" data-aos-duration="800"
							data-aos-delay="200">
							<div class="flex flex-wrap gap-2">
								...
								foreach ($tags as $tag):
									...
									<a href="<?php echo get_tag_link($tag->term_id); ?>"
										...
										data-aos="fade-in" data-aos-duration="600" data-aos-delay="<?php echo $delay; ?>">
										<?php echo $tag->name; ?>
									</a>
									<?php
									$delay += 100;
