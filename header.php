...
<head>
	...
	})(window,document,'script','dataLayer','GTM-TBZH84J');</script>
	<!-- End Google Tag Manager -->

	<!-- Google Search Console -->
	<meta name="google-site-verification" content="d0vYJIl4Z1-mGm9jQm43xH2Gv7w74kGcXR3QHoFk-Zw" />

	<!-- Google Analytics GA4 -->
	<script async src="https://www.googletagmanager.com/gtag/js?id=G-YXYJ34SNH4"></script>
	<script>
	  window.dataLayer = window.dataLayer || [];
	  function gtag(){dataLayer.push(arguments);}
	  gtag('js', new Date());

	  gtag('config', 'G-YXYJ34SNH4');
	</script>
	...
	fbq('init', '1908581536474318');
	fbq('track', 'PageView');
	</script>
	<noscript><img height="1" width="1" style="display:none"
	src="https://www.facebook.com/tr?id=1908581536474318&ev=PageView&noscript=1"
	/></noscript>
	<!-- End Meta Pixel Code -->

	<!-- Linkedin Pixel -->
	<script type="text/javascript">
	_linkedin_partner_id = "1624266";
	...
	<noscript>
	<img height="1" width="1" style="display:none;" alt="" src="https://px.ads.linkedin.com/collect/?pid=1624266&fmt=gif" />
	</noscript>
...
<body <?php body_class(); ?>>
	...
	<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TBZH84J"
						...
						<div class="p-8 mx-auto flex min-h-[300px]">
							...
							<div class="w-3/4 pl-8 py-2">
								...
								<div id="por-necesidad" class="tab-content">
									...
									if (have_rows('megamenu_por_necesidad', 'megamenu-header')):
										// Contar el total de secciones
										$total_sections = count(get_field('megamenu_por_necesidad', 'megamenu-header'));
										...
										while (have_rows('megamenu_por_necesidad', 'megamenu-header')):
											the_row();
								...
								<div id="por-productos" class="tab-content hidden">
									<?php
									if (have_rows('megamenu_por_productos', 'megamenu-header')):
										$total_sections = count(get_field('megamenu_por_productos', 'megamenu-header'));
										...
										while (have_rows('megamenu_por_productos', 'megamenu-header')):
											the_row();
											$titulo = get_sub_field('titulo_seccion');
											$icono = get_sub_field('icono_svg');
											?>
								...
								<div id="por-sector" class="tab-content hidden">
									<?php
									if (have_rows('megamenu_por_sector', 'megamenu-header')):
										$total_sections = count(get_field('megamenu_por_sector', 'megamenu-header'));
										...
										while (have_rows('megamenu_por_sector', 'megamenu-header')):
											the_row();
											$titulo = get_sub_field('titulo_seccion');
											$icono = get_sub_field('icono_svg');
											?>
				...
				<div class="flex-1 overflow-y-auto">
					...
					<?php foreach (['por_necesidad', 'por_productos', 'por_sector'] as $field_key): ?>
						<nav id="mobile-level-3-<?php echo str_replace('_', '-', $field_key); ?>" class="mobile-menu-level">
							...
							<?php if (have_rows('megamenu_' . $field_key, 'megamenu-header')): ?>
								<?php while (have_rows('megamenu_' . $field_key, 'megamenu-header')):
									the_row();
									$titulo = get_sub_field('titulo_seccion');
									$icono = get_sub_field('icono_svg');
									?>
