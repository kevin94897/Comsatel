...
<body <?php body_class(); ?>>
	...
	<div id="page" class="site">
		...
		<header id="masthead"
			...
			<div class="container-full mx-auto px-4 lg:px-8">
				<div class="flex items-center justify-between py-4 lg:py-6">
					...
					<!-- Mega Menu Container -->
					<div id="mega-menu" class="fixed left-1/2 -translate-x-1/2 w-[95vw] max-w-[1200px] bg-white shadow-2xl border-t border-gray-100 rounded-lg z-[100] transition-all duration-300 opacity-0 invisible pointer-events-none">
						<div class="p-8 mx-auto flex min-h-[300px]">
							...
							<div class="w-1/4 pr-6 flex flex-col space-b-2 border-r border-gray-100">
								<div class="menu-tab-item active group/item flex items-center justify-between cursor-pointer p-3 rounded-md hover:bg-gray-50 transition-all text-red-600 font-semibold" data-target="por-necesidad">
								...
								<div class="menu-tab-item group/item flex items-center justify-between cursor-pointer p-3 rounded-md hover:bg-gray-50 transition-all text-gray-700" data-target="por-productos">
									<div class="flex items-center gap-3 text-xs">
										<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
								...
								<div class="menu-tab-item group/item flex items-center justify-between cursor-pointer p-3 rounded-md hover:bg-gray-50 transition-all text-gray-700" data-target="por-sector">
									<div class="flex items-center gap-3 text-xs">
										<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
							...
							<div class="w-3/4 pl-8 py-2">
								...
								<div id="por-necesidad" class="tab-content">
									...
									if (have_rows('megamenu_por_necesidad', 'option')):
										...
										while (have_rows('megamenu_por_necesidad', 'option')): the_row();
											...
											<div class="mega-menu-section">
												...
												<?php if (have_rows('items_menu')): ?>
													<ul class="space-b-2.5">
														<?php while (have_rows('items_menu')): the_row();
								...
								<div id="por-productos" class="tab-content hidden">
									...
									if (have_rows('megamenu_por_productos', 'option')):
										...
										while (have_rows('megamenu_por_productos', 'option')): the_row();
											$titulo = get_sub_field('titulo_seccion');
											$icono = get_sub_field('icono_svg');
									?>
											<div class="mega-menu-section">
								...
								<div id="por-sector" class="tab-content hidden">
									...
									if (have_rows('megamenu_por_sector', 'option')):
										...
										while (have_rows('megamenu_por_sector', 'option')): the_row();
											$titulo = get_sub_field('titulo_seccion');
											$icono = get_sub_field('icono_svg');
									?>
											<div class="mega-menu-section">
        ...
        <?php echo $is_transparent_header ? 'btn-outline-white' : 'btn-outline'; ?> text-[14px]">
							...
							<div class="absolute left-0 mt-2 w-[145px] bg-white rounded-md shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 overflow-hidden border border-gray-100">
								<div class="py-2">
									<a href="#" class="flex items-center py-3 px-5 hover:bg-gray-50 group/item transition-colors">
									...
									<a href="#" class="flex items-center py-3 px-5 hover:bg-gray-50 group/item transition-colors">
										...
										<span class="text-gray-600 font-medium group-hover/item:text-gray-900 text-xs">Tracksolid</span>
									</a>

									<a href="#" class="flex items-center py-3 px-5 hover:bg-gray-50 group/item transition-colors">
										<span class="text-red-500 mr-2">
											<svg xmlns="http://www.w3.org/2000/svg" width="13" height="9" viewBox="0 0 13 9" fill="none">
												<path d="M1.83333 0C1.3471 0 0.880788 0.193154 0.536971 0.536971C0.193154 0.880787 0 1.3471 0 1.83333V6.83333C0 7.31956 0.193154 7.78588 0.536971 8.1297C0.880788 8.47351 1.3471 8.66667 1.83333 8.66667H7.5C7.98623 8.66667 8.45255 8.47351 8.79636 8.1297C9.14018 7.78588 9.33333 7.31956 9.33333 6.83333V5.77067L11.6127 7.80067C12.1493 8.27867 13 7.89733 13 7.178V1.24333C13 0.523333 12.1493 0.142667 11.6127 0.620667L9.33333 2.65067V1.83333C9.33333 1.3471 9.14018 0.880787 8.79636 0.536971C8.45255 0.193154 7.98623 0 7.5 0H1.83333Z" fill="#FF4D4D" />
											</svg>
										</span>
										<span class="text-gray-600 font-medium group-hover/item:text-gray-900 text-xs">CLVideo</span>
									</a>
									...
									<a href="#" class="flex items-center py-3 px-5 hover:bg-gray-50 group/item transition-colors">
										...
										<span class="text-gray-600 font-medium group-hover/item:text-gray-900 text-xs">Trackmobile</span>
									</a>
								</div>
							</div>
						</div>
				...
				<div class="container-full mx-auto px-4 lg:px-8">
					<div class="flex items-center justify-between py-4 lg:py-6">
						...
						<div class="mobile-menu-logo">
							...
							$footer_logo_id = get_theme_mod('footer_logo');
							if ($footer_logo_id): ?>
								<img src="<?php echo esc_url(wp_get_attachment_image_url($footer_logo_id, 'full')); ?>" class="w-auto" alt="Comsatel">
							<?php endif; ?>
						</div>
				...
				<div class="flex-1 overflow-y-auto">
					...
					<nav id="mobile-level-1" class="mobile-menu-level active">
						<div class="px-4 py-6 space-y-2">
							<a href="<?php echo esc_url(home_url('/calculadora')); ?>" class="btn btn-primary !bg-[#CC0000] w-full !rounded-md !text-sm">Cotiza ahora</a>
        ...
        <?php echo $is_transparent_header ? 'btn-outline' : 'btn-outline'; ?> text-[14px]">
									<span>Iniciar Sesión</span>
									<svg xmlns="http://www.w3.org/2000/svg" id="arrowIcon" class="w-4 h-4 transition-transform group-hover:rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor">
										<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
									</svg>
								</button>

								<div id="loginDropdown" class="mt-2 w-full bg-white rounded-md shadow-xl group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 overflow-hidden border border-gray-100">
									<div class="py-2">
										<a href="#" class="flex items-center py-3 px-5 hover:bg-gray-50 group/item transition-colors">
											<span class="text-red-500 mr-2">
												<svg xmlns="http://www.w3.org/2000/svg" width="16" height="15" viewBox="0 0 16 15" fill="none">
							...
							if ($menu_items) :
								foreach ($menu_items as $item) :
									if ($item->menu_item_parent == 0) :
										...
										if ($has_children) : ?>
											<li>
												<button class="mobile-nav-trigger w-full px-5 py-6 flex items-center justify-between text-gray-900 bg-white border-none" data-target="soluciones">
										...
										<?php else : ?>
											<li>
												<a href="<?php echo esc_url($item->url); ?>" class="block px-5 py-6 font-normal text-gray-900">
					...
					<nav id="mobile-level-2-soluciones" class="mobile-menu-level">
						<button class="mobile-back-trigger w-full px-5 py-4 border-b border-gray-100 flex items-center gap-2 text-gray-900 bg-gray-50">
							<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
						...
						<ul class="divide-y divide-gray-50">
							...
							foreach ($tabs as $id => $data): ?>
								<li>
									<button class="mobile-nav-trigger w-full px-5 py-4 flex items-center justify-between text-gray-900 bg-white border-none" data-target="<?php echo $id; ?>">
					...
					<?php foreach (['por_necesidad', 'por_productos', 'por_sector'] as $field_key): ?>
						<nav id="mobile-level-3-<?php echo str_replace('_', '-', $field_key); ?>" class="mobile-menu-level">
							...
							<?php if (have_rows('megamenu_' . $field_key, 'option')): ?>
								<?php while (have_rows('megamenu_' . $field_key, 'option')): the_row();
									$titulo = get_sub_field('titulo_seccion');
									$icono = get_sub_field('icono_svg');
								?>
									<div class="flex items-center gap-2 font-semibold text-gray-800 text-md px-5 py-3">
										<?php if ($icono) echo '<span class="w-4 h-4">' . $icono . '</span>'; ?>
										<?php echo esc_html($titulo); ?>
									</div>
									<ul class="bg-white mb-4">
										<?php if (have_rows('items_menu')): while (have_rows('items_menu')): the_row();
												$enlace = get_sub_field('enlace');
												if ($enlace): ?>
													<li>
														<a href="<?php echo esc_url($enlace['url']); ?>" class="block px-6 py-1 text-sm text-gray-700 border-b border-gray-50 last:border-0">
