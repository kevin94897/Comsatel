        ...
        <div class="container mx-auto px-4">
            ...
            <div class="flex flex-row md:flex-row justify-between items-center gap-2 md:gap-8 mb-4 md:mb-12">
                ...
                <div class="flex flex-row md:gap-4 items-center">
                    <!-- Category Filter -->
                    <div class="flex-1 relative hidden md:block basis-1/2 md:basis-[200px] shrink-0"
                        id="category-filter-wrapper">
                        <button id="category-dropdown-toggle"
                            class="md:flex hidden items-center justify-between text-sm w-full px-4 md:py-5 py-3 font-normal text-black !bg-transparent border border-gray-400 rounded-md transition-all duration-200 outline-none cursor-pointer appearance-none focus:border-primary focus:ring-2 focus:ring-primary/20 leading-none">
                            <span>Tema</span>
                            <svg class="transition-transform duration-200" width="12" height="12" viewBox="0 0 12 12"
                        ...
                        <div id="category-dropdown-menu"
                            class="hidden absolute top-full left-0 w-full mt-1 bg-white border border-gray-400 rounded-md shadow-lg z-50 overflow-y-auto p-4">
                                ...
                                foreach ($categories as $cat):
                                    ...
                                    <label class="flex items-center gap-3 cursor-pointer group">
                                        <div class="relative flex items-center">
                                            <input type="checkbox" name="blog_category[]"
                                                value="<?php echo $cat->term_id; ?>"
                                                class="peer sr-only blog-category-checkbox">
                                            <div
                                                class="w-5 h-5 border-2 border-gray-300 rounded-sm transition-all peer-checked:bg-primary peer-checked:border-primary">
                                            </div>
                                            <svg class="absolute inset-0 m-auto w-3.5 h-3.5 text-white opacity-0 peer-checked:opacity-100 transition-opacity"
                                                ...
                                                <path d="M2.5 6L5 8.5L9.5 3.5" stroke="currentColor" stroke-width="2"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                            </svg>
                                        </div>
                                        <span
                                            class="text-sm font-normal text-black group-hover:text-primary transition-colors">
                    ...
                    <div class="basis-full md:basis-[200px] shrink-0">
                        <select id="blog-filter"
                            class="text-xs md:text-sm w-full px-4 py-3 font-normal text-black !bg-transparent border border-gray-400 rounded-md transition-all duration-200 outline-none cursor-pointer appearance-none focus:border-primary focus:ring-2 focus:ring-primary/20 md:pr-12 pr-8 leading-none"
            ...
            <?php if ($blog_query->max_num_pages > 1): ?>
                <div class="flex justify-center items-center gap-4 mt-12">
                    <button id="load-more-posts"
                        class="btn btn-outline min-w-[200px] disabled:opacity-50 disabled:cursor-not-allowed" data-page="1"
